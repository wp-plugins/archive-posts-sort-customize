...
<div class="wrap">
	...
	<h2><?php printf( __( '%1$s %2$s for %3$s %4$s' , $APSC->ltd ) , __( 'Customize' ) ,  __( 'Sort' , $APSC->ltd ) , __( 'Tags' ) , __( 'Archives' ) ); ?></h2>
	...
	<div class="metabox-holder columns-2 <?php echo $APSC->ltd; ?>">
		...
		<div id="postbox-container-1" class="postbox-container">
			...
			<form id="<?php echo $APSC->PageSlug; ?>_form" method="post" action="<?php echo remove_query_arg( $APSC->MsgQ ); ?>">
				...
				<input type="hidden" name="record_field" value="tag" />

				<?php $args = array( 'per_setting' => '' , 'archive' => 'tag' , 'title' => __( 'Default' ) ); ?>
